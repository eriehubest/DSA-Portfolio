...
const ScreenScribble = ({ replayKey, setIntroAnimation }) => {
    ...
    useLayoutEffect(() => {
        ...
        const ctx = gsap.context(() => {
            ...
            const tl = gsap.timeline({
                onComplete: () => {
                    ...
                    const scribblePage = document.querySelector('.screen-scribble');
                    scribblePage.classList.add('hidden')
                }
            });
        ...
        return () => ctx.revert();
    }, [replayKey, setIntroAnimation]);

    return (
        <svg
            ref={root}
            className="screen-scribble absolute z-1000 bg-background"
